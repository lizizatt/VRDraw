...
namespace Leap.PinchUtility.Examples
{
    ...
    public class RGBPinchDraw : MonoBehaviour
    {
        ...
        [SerializeField]
        public RGBSlider rSlider;
        public RGBSlider gSlider;
        public RGBSlider bSlider;
        public RGBSlider aSlider;
        public ButtonDemoToggle enableButton;
        public ButtonDemoToggle clearButton;
        ...
        {
            //check button stats
            if (clearButton != null && clearButton.ToggleState)
            {
                for (int i = 0; i < _pinchDetectors.Length; i++)
                {
                    _drawStates[i].Clear();
        ...
        private class DrawState
        {
            ...
            public DrawState(RGBPinchDraw parent)
            {
                _parent = parent;
            ...
            public void Clear()
            {
                ...
                {
                    GameObject line = GameObject.Find("Line Object");
                    if (line != null)
                    {
                        Destroy(line);
                    }
            ...
            private Color getColor()
            {
                ...
                if (_parent.rSlider != null)
                {
                    r = _parent.rSlider.GetSliderFraction();
                }
                if (_parent.gSlider != null)
                {
                    g = _parent.gSlider.GetSliderFraction();
                }
                if (_parent.bSlider != null)
                {
                    b = _parent.bSlider.GetSliderFraction();
                }
                if (_parent.aSlider != null)
                {
                    a = _parent.aSlider.GetSliderFraction();
                }
            ...
            {
                if (_parent.enableButton != null && _parent.enableButton.ToggleState)
                {
